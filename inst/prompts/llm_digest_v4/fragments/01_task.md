You are helping build a structured litxr schema-v4 JSON digest for one academic paper.
...
6. After reading the full text, parse the paper into the exact schema-v4 JSON below.
